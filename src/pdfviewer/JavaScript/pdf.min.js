...
! function webpackUniversalModuleDefinition(e, t) {
    ...
    return (() => {
        ...
        var __webpack_modules__ = [, (e, t, r) => {
                ...
                t.addLinkAttributes = function addLinkAttributes(e, {
                    url: t,
                    target: r,
                    rel: a,
                    enabled: o = !0
                            ...
                            a.onreadystatechange = () => {
                                if (a.readyState === XMLHttpRequest.DONE) {
                                    if (200 === a.status || 0 === a.status) {
                                        let e;
                                        this.isCompressed && a.response ? e = new Uint8Array(a.response) : !this.isCompressed && a.responseText && (e = (0, n.stringToBytes)(a.responseText));
                                        if (e) {
                                            r({
                                                cMapData: e,
                                                compressionType: t
                ...
                t.DOMSVGFactory = class DOMSVGFactory {
                    create(e, t) {
                        ...
                        const r = document.createElementNS(a, "svg:svg");
                ...
                t.PDFDateString = class PDFDateString {
                    static toDateObject(e) {
                        ...
                        return new Date(Date.UTC(r, s, a, i, l, c))
                    }
                }
            }, (e, t, r) => {
                Object.defineProperty(t, "__esModule", {
                ...
                t.createObjectURL = function createObjectURL(e, t = "", r = !1) {
                    if (URL.createObjectURL && !r) return URL.createObjectURL(new Blob([e], {
                        type: t
                    }));
                    ...
                    for (let t = 0, r = e.length; t < r; t += 3) {
                        const a = 255 & e[t],
                            i = 255 & e[t + 1],
                            o = 255 & e[t + 2];
                        s += n[a >> 2] + n[(3 & a) << 4 | i >> 4] + n[t + 1 < r ? (15 & i) << 2 | o >> 6 : 64] + n[t + 2 < r ? 63 & o : 64]
                    }
                    return s
                };
                ...
                function getDocument(e) {
                    ...
                    let r;
                    if ("string" == typeof e || e instanceof URL) r = {
                        url: e
                    };
                        ...
                        if ("object" != typeof e) throw new Error("Invalid parameter in getDocument, need either string, URL, Uint8Array, or parameter object.");
                    ...
                    for (const e in r) {
                        ...
                        switch (e) {
                            ...
                            case "worker":
                                ...
                                continue;
                            case "data":
                                if (_is_node.isNodeJS && "undefined" != typeof Buffer && t instanceof Buffer) n[e] = new Uint8Array(t);
                                else {
                ...
                class PDFPageProxy {
                    ...
                    render({
                        ...
                        const u = "print" === r ? "print" : "display";
                        this.pendingCleanup = !1;
                        h || (h = this._transport.getOptionalContentConfig());
                        let p = this._intentStates.get(u);
                        if (!p) {
                            p = Object.create(null);
                            this._intentStates.set(u, p)
                        }
                        if (p.streamReaderCancelTimeout) {
                            clearTimeout(p.streamReaderCancelTimeout);
                            p.streamReaderCancelTimeout = null
                        }
                        const f = o || new DefaultCanvasFactory({
                                ownerDocument: this._ownerDocument
                            }),
                            g = new _webgl.WebGLContext({
                                enable: n
                            });
                        if (!p.displayReadyCapability) {
                            p.displayReadyCapability = (0, _util.createPromiseCapability)();
                            p.operatorList = {
                                fnArray: [],
                                argsArray: [],
                                lastChunk: !1
                            ...
                            this._pumpOperatorList({
                                ...
                                annotationStorage: c?.serializable || null
                            })
                        }
                        const complete = e => {
                                p.renderTasks.delete(m);
                                (this.cleanupAfterRender || "print" === u) && (this.pendingCleanup = !0);
                                this._tryCleanup();
                                if (e) {
                        ...
                        ((d = p).renderTasks || (d.renderTasks = new Set)).add(m);
                        const _ = m.task;
                        Promise.all([p.displayReadyCapability.promise, h]).then((([e, t]) => {
                    ...
                    getOperatorList() {
                        ...
                        if (!r.opListReadCapability) {
                            ...
                            ((n = r).renderTasks || (n.renderTasks = new Set)).add(t);
                            r.operatorList = {
                                fnArray: [],
                                argsArray: [],
                                lastChunk: !1
                            ...
                            n = {
                                data: function cloneValue(e) {
                                    ...
                                    if (e instanceof Map) {
                                        s = new Map;
                                        r.set(e, s);
                                        for (const [t, r] of e) s.set(t, cloneValue(r));
                                        return s
                                    }
                                    if (e instanceof Set) {
                                        s = new Set;
                                        r.set(e, s);
                                        for (const t of e) s.add(cloneValue(t));
                                        return s
                                    }
                                    s = Array.isArray(e) ? [] : {};
                                    r.set(e, s);
                                    for (const t in e) {
                                        ...
                                        if (void 0 !== r.value)
                                            if ("function" != typeof r.value) s[t] = cloneValue(r.value);
                                            else if (e.hasOwnProperty?.(t)) throw new Error(`LoopbackPort.postMessage - cannot clone: ${e[t]}`)
                                    }
                                    return s
                                }(e)
                            };
                ...
                class WorkerTransport {
                    ...
                    setupMessageHandler() {
                        ...
                        e.on("obj", (e => {
                            if (this.destroyed) return;
                            const [t, r, n, s] = e, a = this.pageCache[r];
                            if (!a.objs.has(t)) switch (n) {
                                case "Image":
                                    a.objs.resolve(t, s);
                                    const e = 8e6;
                                    s?.data?.length > e && (a.cleanupAfterRender = !0);
                                    break;
                                default:
                    ...
                    saveDocument(e) {
                        return this.messageHandler.sendWithPromise("SaveDocument", {
                            ...
                            annotationStorage: e?.serializable || null,
                ...
                t.FontLoader = s = class GenericFontLoader extends BaseFontLoader {
                    ...
                    _prepareFontLoadEvent(e, t, r) {
                        ...
                        const d = 1482184792;
                        let u = int32(h, 16);
                        for (s = 0, a = c.length - 3; s < a; s += 4) u = u - d + int32(c, s) | 0;
                        ...
                        this.insertRule(p);
                        const f = [];
                        for (s = 0, a = t.length; s < a; s++) f.push(t[s].loadedName);
                        f.push(c);
                ...
                t.AnnotationStorage = class AnnotationStorage {
                    ...
                    getOrCreateValue(e, t) {
                        (0, n.deprecated)("Use getValue instead.");
                    ...
                    getAll() {
                        return this._storage.size > 0 ? (0, s.objectFromMap)(this._storage) : null
                    }
                    get size() {
                ...
                const l = function CanvasExtraStateClosure() {
                    ...
                    c = function CanvasGraphicsClosure() {
                        function CanvasGraphics(e, t, r, n, s, a, i) {
                            this.ctx = e;
                            this.current = new l;
                            this.stateStack = [];
                        ...
                        function putBinaryImageData(e, t, r = null) {
                            ...
                            if (t.kind === n.ImageKind.GRAYSCALE_1BPP) {
                                const t = p.byteLength,
                                    r = new Uint32Array(f.buffer, 0, f.byteLength >> 2),
                                    s = r.length,
                                    A = a + 7 >> 3;
                                let b = 4294967295,
                                    y = n.IsLittleEndianCached.value ? 4278190080 : 255;
                        ...
                        function composeSMask(e, t, r, n) {
                            ...
                            if (t.transferMap || !n.isEnabled) {
                                ! function genericComposeSMask(e, t, r, n, s, a, i) {
                                    ...
                                    for (let s = 0; s < n; s += u) {
                                        const a = Math.min(u, n - s),
                                            p = e.getImageData(0, s, r, a),
                                            f = t.getImageData(0, s, r, a);
                        ...
                        CanvasGraphics.prototype = {
                            beginDrawing({
                                ...
                                this.ctx.restore();
                                if (r) {
                                    const e = this.cachedCanvases.getCanvas("transparent", s, a, !0);
                            ...
                            executeOperatorList: function CanvasGraphics_executeOperatorList(e, t, r, s) {
                                ...
                                for (;;) {
                                    ...
                                    f = i[o];
                                    if (f !== n.OPS.dependency) this[f].apply(this, a[o]);
                                    else
                                        for (const e of a[o]) {
                                ...
                                if (this.contentVisible)
                                    if ("object" == typeof r && r?.getPattern) {
                                        ...
                                        const a = this.getSinglePixelWidth(),
                                            i = this.current.lineWidth * s;
                                        if (a < 0 && -a >= i) {
                                            t.resetTransform();
                                            t.lineWidth = Math.round(this._combinedScaleFactor)
                                        } else t.lineWidth = Math.max(a, i);
                                        t.stroke();
                                        t.restore()
                                    } else {
                            ...
                            paintChar(e, t, r, s, a) {
                                ...
                                if (l.disableFontFace || p) {
                                    ...
                                    i.beginPath();
                                    f(i, h);
                                    s && i.setTransform.apply(i, s);
                                    d !== n.TextRenderingMode.FILL && d !== n.TextRenderingMode.FILL_STROKE || i.fill();
                                    ...
                                    d !== n.TextRenderingMode.FILL && d !== n.TextRenderingMode.FILL_STROKE || i.fillText(e, t, r);
                                    if (d === n.TextRenderingMode.STROKE || d === n.TextRenderingMode.FILL_STROKE)
                                        if (a) {
                                            i.save();
                                            i.moveTo(t, r);
                            ...
                            showText: function CanvasGraphics_showText(e) {
                                ...
                                for (S = 0; S < d; ++S) {
                                    ...
                                    if (r.remeasure && k > 0) {
                                        const e = 1e3 * a.measureText(A).width / s * i;
                                        if (k < e && this.isFontSubpixelAAEnabled) {
                                            ...
                                            a.scale(t, 1);
                                            v /= t
                                        } else k !== e && (v += (k - e) / 2e3 * s / i)
                                    }
                                    if (this.contentVisible && (t.isInFont || r.missingFile))
                                        if (m && !y) a.fillText(A, v, x);
                                        else {
                                            this.paintChar(A, v, x, _, b);
                                            if (y) {
                                                const e = v + s * y.offset.x / i,
                                                    t = x - s * y.offset.y / i;
                            ...
                            showType3Text: function CanvasGraphics_showType3Text(e) {
                                const t = this.ctx,
                                    ...
                                    c = r.wordSpacing,
                                    h = r.textHScale * i,
                                    d = r.fontMatrix || n.FONT_IDENTITY_MATRIX,
                                    u = e.length;
                                let p, f, g, m;
                                if (!(r.textRenderingMode === n.TextRenderingMode.INVISIBLE) && 0 !== a) {
                                    this._cachedGetSinglePixelWidth = null;
                                    t.save();
                                    ...
                                    for (p = 0; p < u; ++p) {
                                        ...
                                        const i = (f.isSpace ? c : 0) + l,
                                            u = s.charProcOperatorList[f.operatorListId];
                                        if (!u) {
                                        ...
                                        g = n.Util.applyTransform([f.width, 0], d)[0] * a + i;
                                        t.translate(g, 0);
                                        r.x += g * h
                                    }
                                    t.restore();
                            ...
                            shadingFill: function CanvasGraphics_shadingFill(e) {
                                ...
                                if (a) {
                                    const e = t.canvas,
                                        ...
                                        o = n.Util.applyTransform([0, s], a),
                                        l = n.Util.applyTransform([r, 0], a),
                                        c = n.Util.applyTransform([r, s], a),
                            ...
                            beginGroup: function CanvasGraphics_beginGroup(e) {
                                ...
                                s = n.Util.intersect(s, i) || [0, 0, 0, 0];
                                const o = Math.floor(s[0]),
                                    l = Math.floor(s[1]);
                                let c = Math.max(Math.ceil(s[2]) - o, 1),
                                ...
                                const f = this.cachedCanvases.getCanvas(p, c, h, !0),
                                    g = f.context;
                                g.scale(1 / d, 1 / u);
                                g.translate(-o, -l);
                            ...
                            paintImageMaskXObject: function CanvasGraphics_paintImageMaskXObject(e) {
                                ...
                                const o = this.cachedCanvases.getCanvas("maskCanvas", r, n),
                                    l = o.context;
                                l.save();
                            ...
                            paintInlineImageXObject: function CanvasGraphics_paintInlineImageXObject(e) {
                                ...
                                this.save();
                                n.scale(1 / t, -1 / r);
                                const s = n.mozCurrentTransformInverse;
                                let a, i, o, l = Math.max(Math.hypot(s[0], s[1]), 1),
                                    c = Math.max(Math.hypot(s[2], s[3]), 1);
                                if ("function" == typeof HTMLElement && e instanceof HTMLElement || !e.data) a = e;
                                else {
                                    i = this.cachedCanvases.getCanvas("inlineImage", t, r);
                                    o = i.context;
                            ...
                            getSinglePixelWidth() {
                                if (null === this._cachedGetSinglePixelWidth) {
                                    const e = this.ctx.mozCurrentTransform,
                                        ...
                                        r = e[0] ** 2 + e[2] ** 2,
                                        n = e[1] ** 2 + e[3] ** 2,
                                        s = Math.sqrt(Math.max(r, n)) / t;
                                    r !== n && this._combinedScaleFactor * s > 1 ? this._cachedGetSinglePixelWidth = -this._combinedScaleFactor * s : t > Number.EPSILON ? this._cachedGetSinglePixelWidth = s : this._cachedGetSinglePixelWidth = 1
                                }
                ...
                const a = function createMeshCanvasClosure() {
                    function drawTriangle(e, t, r, n, s, a, i, o) {
                        ...
                        const p = (l[r] + t.offsetX) * t.scaleX,
                            f = (l[r + 1] + t.offsetY) * t.scaleY,
                            g = (l[n] + t.offsetX) * t.scaleX,
                            m = (l[n + 1] + t.offsetY) * t.scaleY,
                            _ = (l[s] + t.offsetX) * t.scaleX,
                            A = (l[s + 1] + t.offsetY) * t.scaleY;
                        if (f >= A) return;
                        const b = c[a],
                            y = c[a + 1],
                            S = c[a + 2],
                        ...
                        for (let e = w; e <= T; e++) {
                            ...
                            let t;
                            t = e < f ? 0 : e > A ? 1 : (f - e) / (f - A);
                            D = p - (p - _) * t;
                            I = b - (b - P) * t;
                            O = y - (y - k) * t;
                            N = S - (S - R) * t;
                            const r = Math.round(Math.min(E, D)),
                                n = Math.round(Math.max(E, D));
                            let s = d * e + 4 * r;
                            for (let e = r; e <= n; e++) {
                                t = (E - e) / (E - D);
                                t < 0 ? t = 0 : t > 1 && (t = 1);
                    ...
                    function drawFigure(e, t, r) {
                        ...
                        switch (t.type) {
                            case "lattice":
                                ...
                                break;
                            case "triangles":
                                for (a = 0, i = n.length; a < i; a += 3) drawTriangle(e, r, n[a], n[a + 1], n[a + 2], s[a], s[a + 1], s[a + 2]);
                                break;
                            default:
                    ...
                    return function createMeshCanvas(e, t, r, n, s, a, i, o) {
                        const l = Math.floor(e[0]),
                            c = Math.floor(e[1]),
                            h = Math.ceil(e[2]) - l,
                            d = Math.ceil(e[3]) - c,
                            u = Math.min(Math.ceil(Math.abs(h * t[0] * 1.1)), 3e3),
                            p = Math.min(Math.ceil(Math.abs(d * t[1] * 1.1)), 3e3),
                            f = h / u,
                            g = d / p,
                            m = {
                                coords: r,
                        ...
                        if (o.isEnabled) {
                            ...
                            y = i.getCanvas("mesh", _, A, !1);
                            y.context.drawImage(b, 2, 2);
                            b = y.canvas
                        } else {
                            y = i.getCanvas("mesh", _, A, !1);
                            const e = y.context,
                                t = e.createImageData(u, p);
                            if (a) {
                                const e = t.data;
                    ...
                    fromIR: function Mesh_fromIR(e) {
                        ...
                        return {
                            getPattern: function Mesh_getPattern(e, h, d) {
                                ...
                                let u;
                                if (d) u = n.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
                                else {
                                ...
                                const p = a(i, u, t, r, s, d ? null : c, h.cachedCanvases, h.webGLContext);
                                if (!d) {
                ...
                const i = function TilingPatternClosure() {
                    const e = 1,
                        t = 2;
                        ...
                        setFillAndStrokeStyleToContext: function setFillAndStrokeStyleToContext(r, s, a) {
                            ...
                            switch (s) {
                                case e:
                                    ...
                                    break;
                                case t:
                                    const l = n.Util.makeHexColor(a[0], a[1], a[2]);
                                    i.fillStyle = l;
                                    i.strokeStyle = l;
                                    o.fillColor = l;
                                    o.strokeColor = l;
                    ...
                    return {
                        ...
                        composeSMask: function composeSMask(n, s, a) {
                            ...
                            r || function initSmaskGL() {
                                ...
                                const s = e;
                                e = null;
                                const a = createProgram(s, [createVertexShader(s, "  attribute vec2 a_position;                                      attribute vec2 a_texCoord;                                                                                                      uniform vec2 u_resolution;                                                                                                      varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec2 clipSpace = (a_position / u_resolution) * 2.0 - 1.0;       gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_texCoord = a_texCoord;                                      }                                                             "), createFragmentShader(s, "  precision mediump float;                                                                                                        uniform vec4 u_backdrop;                                        uniform int u_subtype;                                          uniform sampler2D u_image;                                      uniform sampler2D u_mask;                                                                                                       varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec4 imageColor = texture2D(u_image, v_texCoord);               vec4 maskColor = texture2D(u_mask, v_texCoord);                 if (u_backdrop.a > 0.0) {                                         maskColor.rgb = maskColor.rgb * maskColor.a +                                   u_backdrop.rgb * (1.0 - maskColor.a);         }                                                               float lum;                                                      if (u_subtype == 0) {                                             lum = maskColor.a;                                            } else {                                                          lum = maskColor.r * 0.3 + maskColor.g * 0.59 +                        maskColor.b * 0.11;                                     }                                                               imageColor.a *= lum;                                            imageColor.rgb *= imageColor.a;                                 gl_FragColor = imageColor;                                    }                                                             ")]);
                                s.useProgram(a);
                                const i = {};
                                i.gl = s;
                                i.canvas = n;
                                ...
                                const o = s.getAttribLocation(a, "a_texCoord"),
                            ...
                            const d = createTexture(h, n, h.TEXTURE0),
                        ...
                        drawFigures: function drawFigures(r, s, a, i, o) {
                            n || function initFiguresGL() {
                                ...
                                const s = e;
                                e = null;
                                const a = createProgram(s, [createVertexShader(s, "  attribute vec2 a_position;                                      attribute vec3 a_color;                                                                                                         uniform vec2 u_resolution;                                      uniform vec2 u_scale;                                           uniform vec2 u_offset;                                                                                                          varying vec4 v_color;                                                                                                           void main() {                                                     vec2 position = (a_position + u_offset) * u_scale;              vec2 clipSpace = (position / u_resolution) * 2.0 - 1.0;         gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_color = vec4(a_color / 255.0, 1.0);                         }                                                             "), createFragmentShader(s, "  precision mediump float;                                                                                                        varying vec4 v_color;                                                                                                           void main() {                                                     gl_FragColor = v_color;                                       }                                                             ")]);
                                s.useProgram(a);
                                const i = {};
                                i.gl = s;
                                i.canvas = r;
                            ...
                            let d = 0;
                            for (let e = 0, t = i.length; e < t; e++) switch (i[e].type) {
                                case "lattice":
                                    d += ((i[e].coords.length / i[e].verticesPerRow | 0) - 1) * (i[e].verticesPerRow - 1) * 6;
                                    break;
                                case "triangles":
                                    d += i[e].coords.length
                            }
                            const u = new Float32Array(2 * d),
                ...
                class AnnotationElement {
                    ...
                    _createContainer(e = !1) {
                        ...
                        if (!e && t.borderStyle.width > 0) {
                            ...
                            t.color ? a.style.borderColor = s.Util.makeHexColor(0 | t.color[0], 0 | t.color[1], 0 | t.color[2]) : a.style.borderWidth = 0
                        }
                        a.style.left = `${l[0]}px`;
                        a.style.top = `${l[1]}px`;
                        a.style.width = `${i}px`;
                ...
                class WidgetAnnotationElement extends AnnotationElement {
                    ...
                    _setColor(e) {
                        ...
                        for (const e of ["bgColor", "fillColor", "fgColor", "textColor", "borderColor", "strokeColor"]) {
                            let r = t[e];
                            if (r) {
                                r = i.ColorConverters[`${r[0]}_HTML`](r.slice(1));
                                switch (e) {
                                    case "bgColor":
                                    case "fillColor":
                                        n.backgroundColor = r;
                ...
                class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                    constructor(e) {
                        super(e, {
                            isRenderable: e.renderInteractiveForms || !e.data.hasAppearance && !!e.data.fieldValue
                        })
                    }
                    render() {
                            ...
                            if (this.enableScripting && this.hasJSActions) {
                                ...
                                r.addEventListener("updatefromsandbox", (r => {
                                    const {
                                        ...
                                        valueAsString() {
                                            a.formattedValue = n.valueAsString || "";
                                            r.target !== document.activeElement && (r.target.value = a.formattedValue);
                                            e.setValue(t, {
                                                formattedValue: a.formattedValue
                                            })
                                        },
                                        focus() {
                                            setTimeout((() => r.target.focus({
                                                preventScroll: !1
                                            })), 0)
                                        },
                                        userName() {
                                ...
                                this.data.actions?.Keystroke && r.addEventListener("input", (e => {
                                    let r = -1,
                                        n = -1;
                                    a.beforeInputSelectionRange && ([r, n] = a.beforeInputSelectionRange);
                                    this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
                                        source: this,
                                        detail: {
                                            id: t,
                    ...
                    _setTextStyle(e) {
                        const t = ["left", "center", "right"],
                            ...
                            a = e.style;
                        r && (a.fontSize = `${r}px`);
                        a.color = s.Util.makeHexColor(n[0], n[1], n[2]);
                ...
                class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
                    ...
                    render() {
                        const e = this.annotationStorage,
                            ...
                            r = t.id,
                            n = e.getValue(r, {
                                value: t.fieldValue && (t.exportValue && t.exportValue === t.fieldValue || !t.exportValue && "Off" !== t.fieldValue)
                            }).value;
                        ...
                        s.addEventListener("change", (function(t) {
                            ...
                            for (const r of document.getElementsByName(n))
                                if (r !== t.target) {
                                    r.checked = !1;
                                    e.setValue(r.parentNode.getAttribute("data-annotation-id"), {
                                        value: !1
                                    })
                                } e.setValue(r, {
                ...
                class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
                    ...
                    render() {
                        ...
                        s.addEventListener("change", (function(t) {
                            ...
                            for (const t of document.getElementsByName(n.name)) t !== n && e.setValue(t.getAttribute("id"), {
                                value: !1
                            });
                            e.setValue(r, {
                                value: n.checked
                        ...
                        if (this.enableScripting && this.hasJSActions) {
                            ...
                            s.addEventListener("updatefromsandbox", (t => {
                                const {
                                    ...
                                    hidden() {
                                        t.target.style.visibility = s.hidden ? "hidden" : "visible";
                                        e.setValue(r, {
                                            hidden: s.hidden
                                        })
                                    },
                                    editable() {
                                        t.target.disabled = !s.editable
                                    }
                                };
                                Object.keys(s).filter((e => e in a)).forEach((e => a[e]()));
                                this._setColor(t)
                            }));
                            this._setEventListeners(s, [
                                ["change", "Validate"],
                            ...
                            r.addEventListener("updatefromsandbox", (n => {
                                const {
                                    ...
                                    remove() {
                                        ...
                                        r.remove(i);
                                        if (a.length > 0) {
                                            -1 === Array.prototype.findIndex.call(a, (e => e.selected)) && (a[0].selected = !0)
                                        }
                                        e.setValue(t, {
                                            value: getValue(n, !0),
                                            items: getItems(n)
                                    ...
                                    insert() {
                                        const {
                                            ...
                                            displayValue: i,
                                            exportValue: o
                                        } = s.insert, l = document.createElement("option");
                                        l.textContent = i;
                                        l.value = o;
                                        r.insertBefore(l, r.children[a]);
                                        e.setValue(t, {
                                            value: getValue(n, !0),
                                            items: getItems(n)
                                        })
                                    ...
                                    items() {
                                        ...
                                        for (const e of a) {
                                            const {
                                                displayValue: t,
                                                exportValue: n
                                            } = e, s = document.createElement("option");
                                            s.textContent = t;
                                            s.value = n;
                                            r.appendChild(s)
                                        }
                                    ...
                                    hidden() {
                                        n.target.style.visibility = s.hidden ? "hidden" : "visible";
                                        e.setValue(t, {
                                            hidden: s.hidden
                                        })
                                    },
                                    editable() {
                                        n.target.disabled = !s.editable
                                    }
                                };
                                Object.keys(s).filter((e => e in a)).forEach((e => a[e]()));
                                this._setColor(n)
                ...
                class PopupAnnotationElement extends AnnotationElement {
                    ...
                    render() {
                        ...
                        const r = new PopupElement({
                            ...
                            n = this.page,
                            a = s.Util.normalizeRect([this.data.parentRect[0], n.view[3] - this.data.parentRect[1] + n.view[1], this.data.parentRect[2], n.view[3] - this.data.parentRect[3] + n.view[1]]),
                    ...
                    render() {
                        ...
                        if (r) {
                            const e = .7 * (255 - r[0]) + r[0],
                                n = .7 * (255 - r[1]) + r[1],
                                a = .7 * (255 - r[2]) + r[2];
                            t.style.backgroundColor = s.Util.makeHexColor(0 | e, 0 | n, 0 | a)
                        }
                    ...
                    static render(e) {
                        ...
                        for (const r of t) {
                            ...
                            if (t.isRenderable) {
                                ...
                                if (Array.isArray(n))
                                    for (const t of n) e.div.appendChild(t);
                                else t instanceof PopupAnnotationElement ? e.div.prepend(n) : e.div.appendChild(n)
                            }
                        }
                    }
                    static update(e) {
                ...
                t.ColorConverters = class ColorConverters {
                    ...
                    static RGB_CMYK([e, t, r]) {
                        const n = 1 - e,
                            s = 1 - t,
                            a = 1 - r;
                        return ["CMYK", n, s, a, Math.min(n, s, a)]
                    }
                }
            }, (e, t, r) => {
                Object.defineProperty(t, "__esModule", {
                ...
                const s = function renderTextLayerClosure() {
                    ...
                    function appendText(s, a, i, o) {
                        ...
                        s._textDivs.push(l);
                        if (function isAllWhitespace(e) {
                                return !r.test(e)
                            }(a.str)) {
                            c.isWhitespace = !0;
                            s._textDivProperties.set(l, c);
                            return
                        }
                        const h = n.Util.transform(s._viewport.transform, a.transform);
                        let d = Math.atan2(h[1], h[0]);
                        const u = i[a.fontName];
                        u.vertical && (d += Math.PI / 2);
                        const p = Math.hypot(h[2], h[3]),
                            f = p * function getAscent(r, n) {
                                const s = t.get(r);
                                if (s) return s;
                                n.save();
                                n.font = `30px ${r}`;
                                const a = n.measureText("");
                                let i = a.fontBoundingBoxAscent,
                                ...
                                n.clearRect(0, 0, e, e);
                                n.strokeText("g", 0, 0);
                                let l = n.getImageData(0, 0, e, e).data;
                                o = 0;
                                ...
                                n.strokeText("A", 0, e);
                                l = n.getImageData(0, 0, e, e).data;
                                i = 0;
                                for (let t = 0, r = l.length; t < r; t += 4)
                                    if (l[t] > 0) {
                                        i = e - Math.floor(t / 4 / e);
                                        break
                                    } n.restore();
                                if (i) {
                                    const e = i / (i + o);
                        ...
                        l.textContent = a.str;
                        l.dir = a.dir;
                        s._fontInspectorEnabled && (l.dataset.fontName = a.fontName);
                        0 !== d && (c.angle = d * (180 / Math.PI));
                        let _ = !1;
                        if (a.str.length > 1) _ = !0;
                        else if (a.transform[0] !== a.transform[3]) {
                            const e = Math.abs(a.transform[0]),
                                t = Math.abs(a.transform[3]);
                            e !== t && Math.max(e, t) / Math.min(e, t) > 1.5 && (_ = !0)
                        }
                        _ && (u.vertical ? c.canvasWidth = a.height * s._viewport.scale : c.canvasWidth = a.width * s._viewport.scale);
                        s._textDivProperties.set(l, c);
                        s._textContentStream && s._layoutText(l);
                        if (s._enhanceTextSelection) {
                            let e = 1,
                                t = 0;
                            if (0 !== d) {
                                e = Math.cos(d);
                            ...
                            const r = (u.vertical ? a.height : a.width) * s._viewport.scale,
                                i = p;
                            let o, c;
                            if (0 !== d) {
                                o = [e, t, -t, e, g, m];
                                c = n.Util.getAxialAlignedBoundingBox([0, 0, r, i], o)
                            } else c = [g, m, g + r, m + i];
                            s._bounds.push({
                                left: c[0],
                                top: c[1],
                    ...
                    function render(e) {
                        ...
                        if (n > 1e5) {
                            ...
                            if (!e._textContentStream)
                                for (let r = 0; r < n; r++) e._layoutText(t[r]);
                            e._renderingDone = !0;
                            r.resolve()
                        }
                    }
                    ...
                    function expand(e) {
                        ...
                        for (let r = 0; r < s.length; r++) {
                            ...
                            if (0 === i.angle) {
                                i.paddingLeft = t[r].left - s[r].left;
                                i.paddingTop = t[r].top - s[r].top;
                                i.paddingRight = s[r].right - t[r].right;
                                i.paddingBottom = s[r].bottom - t[r].bottom;
                            ...
                            i.paddingLeft = findPositiveMin(p, 32, 16) / f;
                            i.paddingTop = findPositiveMin(p, 48, 16) / f;
                            i.paddingRight = findPositiveMin(p, 0, 16) / f;
                            i.paddingBottom = findPositiveMin(p, 16, 16) / f;
                            e._textDivProperties.set(a, i)
                        }
                    }
                    ...
                    function expandBoundsLTR(e, t) {
                        ...
                        t.forEach((function(e) {
                            ...
                            for (i = t; i <= a; i++) {
                                ...
                                for (o = a + 1; !e && o < r.length && r[o].end <= s.y2; o++) e = r[o].boundary === s;
                        ...
                        _render: function TextLayer_render(t) {
                            ...
                            if (this._textContent) {
                                const e = this._textContent.items,
                                    t = this._textContent.styles;
                                this._processItems(e, t);
                                r.resolve()
                            } else {
                            ...
                            r.promise.then((() => {
                                s = null;
                                t ? this._renderTimer = setTimeout((() => {
                                    render(this);
                                    this._renderTimer = null
                                }), t) : render(this)
                    ...
                    t.SVGGraphics = SVGGraphics = class SVGGraphics {
                        ...
                        convertOpList(e) {
                            ...
                            return function opListToTree(e) {
                                ...
                                const r = [];
                                for (const n of e)
                                    if ("save" !== n.fn) "restore" === n.fn ? t = r.pop() : t.push(n);
                                    else {
                                        t.push({
                                            fnId: 92,
                                            fn: "group",
                        ...
                        constructPath(e, t) {
                            ...
                            i = i.join(" ");
                            if (r.path && e.length > 0 && e[0] !== n.OPS.rectangle && e[0] !== n.OPS.moveTo) i = r.path.getAttributeNS(null, "d") + i;
                            else {
                ...
                class XfaLayer {
                    static setAttributes(e, t) {
                        for (const [r, n] of Object.entries(t)) null != n && ("style" !== r ? e.setAttribute(r, n) : Object.assign(e.style, n))
                    }
                    static render(e) {
                        const t = e.xfa,
                            r = document.createElement(t.name);
                        t.attributes && XfaLayer.setAttributes(r, t.attributes);
                        const n = [
                                [t, -1, r]
                            ],
                            s = e.div;
                        s.appendChild(r);
                        const a = e.viewport.transform.join(",");
                        s.style.transform = `matrix(${a})`;
                        s.setAttribute("class", "xfaLayer xfaFont");
                        for (; n.length > 0;) {
                            const [e, t, r] = n[n.length - 1];
                            if (t + 1 === e.children.length) {
                                n.pop();
                                continue
                            }
                            const s = e.children[++n[n.length - 1][1]];
                            if (null === s) continue;
                            const {
                                name: a
                            } = s;
                            if ("#text" === a) {
                                r.appendChild(document.createTextNode(s.value));
                                continue
                            }
                            const i = document.createElement(a);
                            r.appendChild(i);
                            s.attributes && XfaLayer.setAttributes(i, s.attributes);
                            s.children && s.children.length > 0 ? n.push([s, -1, i]) : s.value && i.appendChild(document.createTextNode(s.value))
                        }
                    }
                    static update(e) {
                        const t = `matrix(${e.viewport.transform.join(",")})`;
                ...
                class PDFFetchStreamRangeReader {
                    constructor(e, t, r) {
                        ...
                        fetch(i, createFetchOptions(this._headers, this._withCredentials, this._abortController)).then((e => {
                            if (!(0, s.validateResponseStatus)(e.status)) throw (0, s.createResponseStatusError)(e.status, i);
                            this._readCapability.resolve();
                            this._reader = e.body.getReader()
                        })).catch((e => {
        ...
        (() => {
                ...
                c = __w_pdfjs_require__(22);
            {
                ...
                if (e) {
                    const e = __w_pdfjs_require__(23).PDFNodeStream;
                    (0, r.setPDFNetworkStreamFactory)((t => new e(t)))
                } else {
                    const e = __w_pdfjs_require__(26).PDFNetworkStream;
                    let n;
                    (0, t.isFetchSupported)() && (n = __w_pdfjs_require__(27).PDFFetchStream);
                    (0, r.setPDFNetworkStreamFactory)((r => n && (0, t.isValidFetchUrl)(r.url) ? new n(r) : new e(r)))
                }
            }
        })();
